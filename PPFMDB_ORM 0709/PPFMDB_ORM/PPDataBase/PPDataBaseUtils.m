...
@implementation PPDataBaseUtils
...
+ (NSString *)base64EncodedString:(NSString*)original
{
    ...
    return [PPDataBaseUtils getbase64EncodedStringWithData:data];
}

+ (NSString *)base64DecodedString:(NSString *)base64EncodedString
{
    NSData *data = [PPDataBaseUtils dataWithBase64EncodedString:base64EncodedString];
...
+ (BOOL)kStringisEmpty:(NSString *)string
{
